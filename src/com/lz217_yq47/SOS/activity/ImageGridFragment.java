...
import com.lz217_yq47.SOS.BuildConfig;
import com.lz217_yq47.SOS.R;
import com.lz217_yq47.SOS.domain.VideoEntity;
import com.lz217_yq47.SOS.video.util.ImageCache;
import com.lz217_yq47.SOS.video.util.ImageResizer;
import com.lz217_yq47.SOS.video.util.Utils;
import com.lz217_yq47.SOS.widget.RecyclingImageView;
	...
	public void onItemClick(AdapterView<?> parent, View v, final int position, long id) {
		...
		if(position==0)
		{
			...
			if (vEntty.size > 1024 * 1024 * 10) {
				Toast.makeText(getActivity(), "Didn't accept video larger than 10M！", Toast.LENGTH_SHORT).show();
				return;
			}
	...
	private class ImageAdapter extends BaseAdapter {
		...
		public View getView(int position, View convertView, ViewGroup container) {
			...
			if(position==0)
			{
				...
				holder.tvSize.setText("Record video");
